...
<body>
                ...
                <ul class="navbar-nav me-auto"> <!-- Clase para alinear los elementos -->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"> <!-- Submenú desplegable -->
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-solar"><i
                                        class="fas fa-sun"></i> Solar</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-eolica"><i
                                        class="fas fa-wind"></i> Eólica</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-hidraulica"><i
                                        class="fas fa-water"></i> Hidráulica</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-nuclear"><i
                                        class="fas fa-atom"></i> Nuclear</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-carbon"><i
                                        class="fas fa-cloud"></i> Carbón</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-petroleo"><i
                                        class="fa-solid fa-fill-drip"></i>Petróleo</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-gasnatural"><i
                                        class="fa-brands fa-free-code-camp"></i>Gas Natural</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-geotermica"><i
                                        class="fa-solid fa-fire"></i>Geotérmica</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-biomasa"><i
                                        class="fa-solid fa-seedling"></i>Biomasa</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-mareomotriz"><i
                                        class="fa-solid fa-ship"></i>Mareomotriz</a></li>
                            <li><a class="dropdown-item" href="TIPOS DE ENERGÍA.html#energia-volcanica"><i
    ...
    <footer style="text-align: center; background-color: #000000; padding: 20px; border-top: 2px solid #007bff;">
        <div class="footer-links" style="margin-bottom: 15px;">
            ...
            <a href="#" style="margin: 0 10px; color: #007bff; text-decoration: none; font-weight: bold;">Sobre
                Nosotros</a>
        </div>
