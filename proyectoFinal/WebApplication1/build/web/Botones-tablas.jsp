...
<div class="container-simulacion">
    ...
    <div class="card">
        ...
        <a href="./graficaconsulta5.jsp" class="btn-custom">Ver Consumo Promedio</a>
    </div>
    <div class="card">
        <h5 class="card-title">Consumo Relativo</h5>
        <p class="card-text">Consulta la fuente de energía con mayor consumo relativo.</p>
        <a href="./graficaconsulta6.jsp" class="btn-custom">Ver Consumo Relativo</a>
    </div>
    <div class="card">
        ...
        <a href="./graficaconsulta7.jsp" class="btn-custom">Ver Diferencia de Producción</a>
    </div>
    <div class="card">
        <h5 class="card-title">Producción Total</h5>
        <p class="card-text">Consulta la producción total por fuente de energía.</p>
        <a href="./graficaconsulta8.jsp" class="btn-custom">Ver Producción Total</a>
    </div>
</div>
