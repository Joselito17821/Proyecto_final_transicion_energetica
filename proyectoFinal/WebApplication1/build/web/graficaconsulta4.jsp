...
<!-- Encabezado -->
    ...
    <script>
        // URL de la API
        const apiUrl = 'http://localhost:8080/WebApplication1/data4.jsp';
        ...
        fetch(apiUrl)
            ...
            .then(data => {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    productionCell.textContent = item.production.toFixed(2);
...
<script>
    ...
    fetch("http://localhost:8080/WebApplication1/data4.jsp")
        .then(response => response.json())
        .then(data => {
            // Procesar los datos para el gráfico
            const labels = data.map(item => item.name + " " + item.year); // Nombres de las fuentes de energía
